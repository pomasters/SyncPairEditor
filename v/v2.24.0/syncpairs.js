	...
	"actions": {
		"moves": [
			...
			},
			{
				...
				"description": "Activation Condition: When the user uses any moves three times. Deactivation Condition: Cannot be deactivated.  Never misses. Uses a maximum of 6 slots of the user’s move gauge. The more amount used, the greater the power of this attack."
			},
			{
				"user": "Trainer",
				"name": "Going All Out!",
	...
	"actions": {
		"moves": [
			...
			},
			{
				...
				"effect": "-",
				"description": "Activation Condition: When the field of play’s terrain turns into Electric Terrain. Deactivation Condition: When the field of play’s terrain is no longer Electric Terrain. Ignores passive skills that would reduce the damage of this attack. Ignores passive skills that would protect the target against a critical hit. Ignores the target’s Enduring effect. The power of this move is not lowered even if there are multiple targets. Lowers the target’s Defense and Sp. Def by 1 stat rank when the target is paralyzed."
			},
			{
				"user": "Trainer",
